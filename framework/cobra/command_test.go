...
// Related to https://hadebbs/framework/cobra/issues/302.
...
func TestPersistentHooks(t *testing.T) {
	...
	for _, v := range []struct {
		...
		// If the behavior changes (https://hadebbs/framework/cobra/issues/252)
...
// Related to https://hadebbs/framework/cobra/issues/521.
...
// Related to https://hadebbs/framework/cobra/issues/404.
...
// Related to https://hadebbs/framework/cobra/issues/443.
...
// Related to https://hadebbs/framework/cobra/issues/463.
...
// Related to https://hadebbs/framework/cobra/pull/422#discussion_r143918343.
